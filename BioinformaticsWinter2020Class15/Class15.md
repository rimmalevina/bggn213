...
But we dont need the length column, so lets remove
it
...
Note that there are genes that have zero counts in all samples (ie.
columns), we should remove these since we cant work with them or say
anything about them

First identify the zero sum rows, then exclude
them
...
This requires your data to be in a certain format, and there is a helper
...
```
    ...
    ## ENSG00000279457 0.551863246932653   0.581042050747029   0.687079780133178
    ## ENSG00000278566                NA                  NA                  NA
    ## ENSG00000273547                NA                  NA                  NA
    ## ENSG00000187634  3.04034951107424 0.00236303749730971 0.00516278028066155
...
```
    ...
    ## ENSG00000273547                NA                   NA                   NA
    ## ENSG00000187634  3.04034951107424  0.00236303749730971  0.00516278028066155
    ## ENSG00000188976 -12.6301576133496 1.43989540153787e-36 1.76740571999083e-35
    ## ENSG00000187961  5.53432552849561 3.12428248077716e-08  1.1353611754036e-07
    ## ENSG00000187583  0.14923722361139    0.881366448669145    0.918988027114104
    ## ENSG00000187642  1.04074439790984    0.297994191720984    0.403817230025242
    ##                      symbol      entrez
    ##                 <character> <character>
...
Now save the results we have so far, now that they are annotated, as a
.csv file
...
by their degree of up/down-regulation (need to install both of those
packages)
...
Our input will be a vector of fold change values with ENTREZ gene ids
names
...
```
    ...
    ## Info: Working in directory /Users/rimmalevina/Documents/UCSD/Classes/Bioinformatics/bggn213_github/BioinformaticsWinter2020Class15
